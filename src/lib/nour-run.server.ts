...
export const craft: Record<string, string> = {
  sonny: [
    ...
    "الأحداث الجارية: لا تربط العلامة بحدث (مباراة، خبر، مناسبة) إلا بمعطيات مؤكدة أمامك؛ وإن نقصت تفصيلة اسأل عنها سؤالاً واحداً بدل تخمين أسماء أو نتائج.",
    "اكتب باللهجة الفعلية لجمهور العلامة (مصري/خليجي/شامي/مغاربي) لا بفصحى مترجمة، واحترم طول المنصة: إنستغرام ≤ 125 كلمة قبل «المزيد»، إكس ≤ 280 حرفاً، لينكدإن سطر افتتاحي قوي ثم فقرات قصيرة.",
    "الوعود والأسعار والمواعيد لا تُخترع: استخدم ما ذكره المستخدم فقط، وما ينقص اتركه بين قوسين واضحين ليملأه.",
  ].join("\n"),
  eva: [

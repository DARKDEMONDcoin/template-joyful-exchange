...
const t = Date.now();
const res = await runChatTools(admin, { workspaceId: "00000000-0000-0000-0000-000000000000", employeeId: "nour", message: msg, industry: "مطاعم ومأكولات", brand: "المصرية للأغذية", website: "https://www.almasrafood.com", country: "EG", connected: [], targets: [] });
